package UI_components.IntervalsSlider.supportClasses
{
	...
	public class SliderThumbBase extends SkinnableComponent implements IFocusManagerComponent, IValueCarrying
	{
		...
		public function get formattedValue(): String
		{
			...
			var numberConverted:ConversionUtil = new ConversionUtil();
			...
			//return numberConverted.formatTimeValue(parseFloat(formatted_value));
			return numberConverted.formatTimeValue(value);
		}
		...
		{
			//label.text = numberConverted.formatTimeValue(parseFloat(formattedValue));	
