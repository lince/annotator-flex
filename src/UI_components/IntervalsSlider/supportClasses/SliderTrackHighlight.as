package UI_components.IntervalsSlider.supportClasses
{
	...
	import UI_components.IntervalsSlider.events.MouseEventWithInfo;
	import UI_components.IntervalsSlider.skins.track.HSliderWideTrackHighlightSkin;
	...
	public class SliderTrackHighlight extends SkinnableComponent
	{
		...
		public function labelEditor_clickHandler( event: MouseEvent ): void
		{
			var evento:MouseEventWithInfo = new MouseEventWithInfo("labelClicked");			
			evento.setInfo(labelEditor.text);
			dispatchEvent(evento);
